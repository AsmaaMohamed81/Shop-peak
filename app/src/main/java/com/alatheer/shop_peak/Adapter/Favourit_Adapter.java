...
public class Favourit_Adapter extends RecyclerView.Adapter {
        ...
        if (MyHolder instanceof MyHolder)
        {
            ...
            myHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    mainActivity.sendHomeItem(image_resources, itemList, sanf_name, details, price, sanf_id, rating, store_id,colors,price_before_discount,"1");
                }
            });
    ...
    class MyHolder extends RecyclerView.ViewHolder{
        ...
        public void BindData(HomeModel homeModel) {
            ...
            tv_before_discount.setText(homeModel.priceBeforeDis+"LE");
                tv_after_discount.setText(String.valueOf(homeModel.priceAfterDis+"LE"));
